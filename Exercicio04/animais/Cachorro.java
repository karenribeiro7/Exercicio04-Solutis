...
public class Cachorro extends AnimalTerrestreAB {
    ...
    public Cachorro(String nome, String tipoAnimal, int idade, String habitat, double altura, double peso, int quantidadeDePatas) {
    ...
    public void comer(int quantidade) {
        ...
        System.out.println("O cachorro comeu " + quantidade + " gramas de ração.");
    }
